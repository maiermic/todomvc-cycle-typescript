...
function applyDefaults(compilerConfig, loaderConfig) {
...
function readConfigFile(baseDir, query, tsImpl) {
    ...
    var compilerConfig = tsImpl.parseJsonConfigFileContent(jsonConfigFile.config, tsImpl.sys, process.cwd(), existingOptions.options, configFilePath);
    return {
        configFilePath: configFilePath,
        compilerConfig: compilerConfig,
