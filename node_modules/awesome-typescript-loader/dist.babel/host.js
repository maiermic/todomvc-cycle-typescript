    ...
    State.prototype.loadTypesFromConfig = function () {
        ...
        if (options.types) {
            options.types.forEach(function (type) {
                var resolvedTypeReferenceDirective = _this.ts.resolveTypeReferenceDirective(type, _this.configFilePath, options, ts.sys).resolvedTypeReferenceDirective;
                if (resolvedTypeReferenceDirective) {
                    _this.readFileAndAdd(resolvedTypeReferenceDirective.resolvedFileName);
